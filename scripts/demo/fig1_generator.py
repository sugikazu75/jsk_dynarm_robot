...
class Fig1Generator:
    def __init__(self):
        ...
        self.init_target_joint_q = [0, 0.8, 0, -0.4, 0, 0]  # initial joint angle
        self.final_target_ee_pos = [1.5, -0.5, 0.8]  # final end-effector position
    ...
    def main(self):
        ...
        final_target_ee_pos_msg.header.stamp.nsecs = int(0 * 1000000000)
        final_target_ee_pos_msg.header.stamp.secs = 10
